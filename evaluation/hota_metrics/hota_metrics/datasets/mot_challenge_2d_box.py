...
class MotChallenge2DBox(_BaseDataset):
    ...
    @classmethod
    def get_preprocessed_seq_data(cls, raw_data, class_):
        ...
        cls._check_unique_ids(raw_data)

        distractor_class_names = ['person_on_vehicle', 'static_person', 'distractor', 'reflection']
        # if cls.benchmark == 'MOT20':
        #     distractor_class_names.append('non_mot_vehicle')

        distractor_classes = [cls.class_name_to_class_id[x] for x in distractor_class_names]
        cls_id = cls.class_name_to_class_id[class_]
        ...
        for t in range(raw_data['num_timesteps']):
            ...
            if cls.do_preproc and gt_ids.shape[0] > 0 and tracker_ids.shape[0] > 0:
        ...
        cls._check_unique_ids(data, after_preproc=True)
